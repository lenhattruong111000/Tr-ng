...
public class GameBoard {
	...
	public GameBoard() throws Exception {
		...
		gameBoardPane.setPrefWidth(750);
		gameBoardPane.setPrefHeight(562);

		// Init board
		gameBoardPane.setAlignment(Pos.CENTER);
		gameBoardPane.setHgap(cellWidth * 0.3);
		gameBoardPane.setVgap(gameBoardPane.getHgap());
		gameBoardPane.setBackground(
				new Background(new BackgroundImage(new Image("background2.png"), null, null, null, null)));
